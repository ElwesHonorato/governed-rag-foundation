...
worker_chunk_text is a queue-driven stage worker in the pipeline.

Problem it solves:
- Transforms processed document payloads into deterministic chunk artifacts.
...
Boundary:
- Input: Chunk queue messages and processed objects
- Output: Chunk objects and embed queue messages
