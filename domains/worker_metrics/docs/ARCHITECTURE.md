...
worker_metrics is a queue-driven stage worker in the pipeline.

Problem it solves:
- Collects and emits periodic pipeline counters over stage artifacts.
...
Boundary:
- Input: Pipeline stage storage prefixes
- Output: Counter emissions and lineage run events
