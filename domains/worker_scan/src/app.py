...
from configs.constants import HTML_EXTENSIONS, INCOMING_PREFIX, QUEUE_CONFIG_DEFAULT, RAW_PREFIX, S3_BUCKET
...
def run() -> None:
    ...
    stage_queue = StageQueue(settings.broker_url, queue_config=QUEUE_CONFIG_DEFAULT)
