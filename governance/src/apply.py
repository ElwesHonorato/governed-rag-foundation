...
def run_bootstrap(env_name: str) -> int:
    """Apply only static governance entities to DataHub for one environment."""
...
def run_apply(env_name: str) -> int:
    """Apply full governance model to DataHub for one environment."""
