...
class LLMError(RuntimeError):
    """Base error for model backend failures."""


class LLMHTTPError(LLMError):
    """HTTP failure returned by the model backend."""
...
class LLMConnectionError(LLMError):
    """Connection failure talking to the model backend."""


class LLMResponseError(LLMError):
    """Invalid or incomplete payload returned by the model backend."""
