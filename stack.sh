...
Domains:
  storage | vector | queue | lineage | llm | app | worker_scan | worker_parse_document | worker_chunk_text | worker_embed_chunks | worker_index_weaviate | worker_manifest | worker_metrics
USAGE
}
