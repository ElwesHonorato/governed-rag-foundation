...
Domains:
  infra_storage | infra_vector | infra_queue | infra_spark | infra_lineage | infra_portainer | infra_llm | app_rag_api | app_vector_ui | worker_scan | worker_parse_document | worker_chunk_text | worker_embed_chunks | worker_index_weaviate | worker_manifest | worker_metrics
USAGE
}
